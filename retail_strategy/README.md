## Retail Expansion Analysis with Lasso and Ridge Regressions [[view code]](https://github.com/rjwizecom/supervised_machine_learning/blob/main/retail_strategy/notebooks/retail_recommendations.ipynb) 
...
**The code is available [here]( https://github.com/rjwizecom/supervised_machine_learning/blob/main/retail_strategy/notebooks/retail_recommendations.ipynb)**
...
- The ratio between sales and volume for each county, i.e., the number of dollars per litre sold. If this ratio is high in a given county, the stores in that county are, on average, high-end stores. 
...
<p align="center">
   <img src="https://github.com/rjwizecom/supervised_machine_learning/blob/main/retail_strategy/images/hm3.png" width="400">
<p/>
...
```
<p align="center">
   <img src="https://github.com/rjwizecom/supervised_machine_learning/blob/main/retail_strategy/images/output.png" width="700">
<p/>
...
<p align="center">
   <img src="https://github.com/rjwizecom/supervised_machine_learning/blob/main/retail_strategy/images/test.jpg" width="500">
<p/>
...
- The county with weaker competition is Butler. This could provide untapped potential. However, the absence of a reasonable number of stores may indicate, as observed before, that the county's population is simply not interested in this category of product. Again, further investigation must be carried out.
